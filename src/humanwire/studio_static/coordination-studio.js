...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function graphPositions(nodes, useMobile) {
    ...
    const artifactPositions = {
      conflict: { x: 680, y: artifactStart },
      interview: { x: 680, y: artifactStart + artifactPitch },
      evidence: { x: 680, y: artifactStart + artifactPitch * 2 },
      proposal: { x: 680, y: artifactStart + artifactPitch * 3 },
      approval: { x: 855, y: centerY - 86 },
      availability: { x: 855, y: centerY },
      meeting: { x: 855, y: centerY + 86 },
    };
