...
| Master 80-second demo video | available | Final independently decodable 1920×1080 H.264/AAC master; 82.5% is the working Standard-agent product, with illustrative AI footage explicitly labeled. |
...
| Public video URL | available | `https://youtu.be/OJS99qETl3M`; published publicly and embedded on the verified Devpost project. |
